...
import static com.ymm.ebatis.core.common.DslUtils.dateToMillis;
...
abstract class AbstractRange<T, D> implements Range<T, D> {
    ...
    public QueryBuilder toBuilder() {
        Object left = dateToMillis(getMin());
        Object right = dateToMillis(getMax());
        Object middle = dateToMillis(getValue());
