 ...
 */
public abstract class AbstractMultiSearchResponseExtractorProvider extends AbstractResponseExtractorProvider {
    protected AbstractMultiSearchResponseExtractorProvider(ResultType... resultTypes) {
        super(RequestType.MULTI_SEARCH, resultTypes);
    }
